...
def main(config):
    ...
    elif config.dataset == 'one_bar_loop':
    ...
    elif config.model_type in ['sample', 'se', 'short', 'short_res', 'short_one_bar']:
    ...
    valid_loader = get_audio_loader(config.data_path,
                                    ...
                                    input_length=config.input_length,
                                    num_workers=config.num_workers)
    test_loader = get_audio_loader(config.data_path,
                                    config.batch_size,
									split='TEST',
                                    input_length=config.input_length,
                                    num_workers=config.num_workers)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='mtat', choices=['mtat', 'msd', 'jamendo', 'one_bar_loop'])
    parser.add_argument('--model_type', type=str, default='fcn',
						choices=['fcn', 'musicnn', 'crnn', 'sample', 'se', 'short', 'short_res', 'attention', 'hcnn', 'short_one_bar'])
